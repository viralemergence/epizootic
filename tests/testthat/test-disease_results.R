...
test_that("calculate_at_season appends and calculates results correctly", {
  ...
  # Harvested
  expect_equal(result$harvested$mean, array(c(1, rep(0, 119)), dim = c(3, 10, 4)))
  expect_equal(result$harvested$sd, array(c(0, rep(0, 119)), dim = c(3, 10, 4)))
  expect_equal(result$harvested$min, array(c(1, rep(0, 119)), dim = c(3, 10, 4)))
  expect_equal(result$harvested$max, array(c(1, rep(0, 119)), dim = c(3, 10, 4)))
  # All
  expect_equal(result$all$abundance$mean, array(c(3, rep(0, 39)), dim = c(10, 4)))
  expect_equal(result$all$abundance$sd, array(c(0, rep(0, 39)), dim = c(10, 4)))
  expect_equal(result$all$abundance$min, array(c(3, rep(0, 39)), dim = c(10, 4)))
  expect_equal(result$all$abundance$max, array(c(3, rep(0, 39)), dim = c(10, 4)))
  expect_equal(result$all$harvested$mean, array(c(1, rep(0, 39)), dim = c(10, 4)))
  expect_equal(result$all$harvested$sd, array(c(0, rep(0, 39)), dim = c(10, 4)))
  expect_equal(result$all$harvested$min, array(c(1, rep(0, 39)), dim = c(10, 4)))
  expect_equal(result$all$harvested$max, array(c(1, rep(0, 39)), dim = c(10, 4)))
