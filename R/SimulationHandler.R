...
SimulationHandler <- R6Class("SimulationHandler",
  ...
  public = list(
    ...
    #'
    #' @param results_dir Results directory path where the simulation results will be stored. If not provided, the results directory must be set within the manager class object.
    #' @return A list representing the simulation log. Each element of the list corresponds to a simulation run and contains information about the success or failure of the run, any error messages, and the path to the saved results file (if applicable).
    #' @export
