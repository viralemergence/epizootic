...
The core simulation engine of `epizootic` is the function `disease_simulator`, which simulates spatially explicit disease dynamics in populations. Here is the initial state of an idealized theoretical scenario:
